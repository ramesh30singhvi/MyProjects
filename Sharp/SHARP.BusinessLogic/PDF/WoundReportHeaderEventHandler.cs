...
{
    internal class WoundReportHeaderEventHandler : IEventHandler
    {
        ...
        internal WoundReportHeaderEventHandler(Document document, Organization organization, Facility facility, string months)
		{
            _document = document;
        ...
        private Table CreateTitle(int pageCount, int pageNumber)
        {
            ...
            var titleCell = PdfHelper.CreateTextCell("Quarterly Wound Analysis and Trend", 18, 38, 50, 55, (float)((_pageSize.GetWidth() - 40) * 0.6))
                .SetBold()
