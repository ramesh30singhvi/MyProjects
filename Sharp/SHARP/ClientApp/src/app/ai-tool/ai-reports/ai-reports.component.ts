...
import { AIAuditStateEnum, KeywordAIReportFiltersModel, ReportAIStatuses } from '../../models/reports/reports.model';
...
import { KEYWORD_AI_REPORT_COLUMNS_STATE, KEYWORD_AI_REPORT_GRID_COLUMNS, KEYWORD_AI_REPORT_TABLE_FILTERS } from '../../reports/keyword-ai-report/common/keywordAIReportGrid';
...
export class AiReportsComponent implements OnInit {
  ...
  constructor(
    ...
    const keywordAIReportFilterValues = {
  ...
  public onCreateAiReport() {
    this.router.navigate(['aitool/createAIAudit']);
  }
